...
%Furthermore, one can prove the following stability result for $\psi^h$ using
%the same arguments as those used in the proof of \eqref{thm:stability} for the
%continuous setting.
%\begin{theorem} \label{thm:stability_fem}
%The solution $\psi^h$ of \eqref{eqn:FEForm} satisfies the following stability
%estimate:
%\begin{equation}
