...
\begin{tabular}{|c|c|c|c|c|c|c|c|}%c|c|}
  ...
  $\nicefrac{1}{4}$ & $206$ & $3.72\times 10^{-7}$ & $5.50$ & $1.341\times 10^{-5}$ & $4.68$ & $5.62\times 10^{-4}$ & $3.96$ \\[0.2em] % & $5.542\times 10^{-7}$ & $2.958$ \\
...
\begin{tabular}{|c|c|c|c|c|c|c|c|}%c|c|}
  ...
  $\nicefrac{1}{8}$ & $1958$ & $8.40\times 10^{-4}$ & $3.75$ & $5.91\times 10^{-2}$ & $2.76$ & $5.66\times 10^1$ & $1.92$ \\[0.2em] % & $0.5.973\times 10^{-2}$ & $3.249$ \\
  $\nicefrac{1}{16}$ & $7366$ & $2.82\times 10^{-5}$ & $4.898$ & $4.008\times 10^{-3}$ & $3.88$ & $7.38\times 10^{-1}$ & $2.94$ \\[0.2em] % & $2.979\times 10^{-5}$ & $4.326$ \\
  $\nicefrac{1}{32}$ & $28550$ & $5.59\times 10^{-7}$ & $5.66$ & $1.607\times 10^{-4}$ & $4.64$ & $5.97\times 10^{-2}$ & $3.63$ \\[0.2em] % & $8.632\times 10^{-7}$ & $5.109$ \\
 \hline
\end{tabular}
%}
\end{center}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|}%c|c|}
  ...
  $h$ & $DoFs$ & $e_0$ & $L_2$ order & $e_1$ & $H^1$ order & $e_2$ & $H^2$ order \\[0.2em] % & $e_{\infty}$ & $L_{\infty}$ order \\
  \hline
  $\nicefrac{1}{2}$ & $138$ & $4.10\times 10^{-3}$ & $-$ & $4.91\times 10^{-2}$ & $NaN$ & $8.61\times 10^{-1}$ & $NaN$\\
