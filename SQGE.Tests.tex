...
\subsection{North Atlantic} \label{sse:NATest}
{\color{red} {\LARGE Work on this, i.e. more references and details.}
...
the North Atlantic. This is needed to ensure a unique streamfunction.
Additionally, the Atlantic was closed off from the Mediterranean at the Straits
of Gibraltar. The resultant FE mesh can be seen in \autoref{fig:AtlanticMesh}.
...
\sin(\frac{\pi}{2} y)$ which is the same forcing function given by Bryan
\cite{Bryan1963}. We choose similar parameters as those used in
...
\begin{table}
  ...
  \caption{Table of parameter values used for the simulations of the North
    Atlantic \cite{delSastre04}, where $A,\theta_0,\omega,H,L,r_e,\rho$ are the
...
\subsection{Mediterranean} \label{sse:MedTest}
{\color{red} {\LARGE Work on this some more, i.e. more reference and details.}
...
\begin{tabular}{|c|c|c|c|c|c|c|c|}%c|c|}
  ...
  \hline
$\nicefrac{1}{20}$ & $1074$ & $1.82\times 10^{-6}$ & $-$ & $1.76\times 10^{-4}$ & $-$ & $4.81\times 10^{-2}$ & $-$ \\
$\nicefrac{1}{40}$ & $3587$ & $7.27\times 10^{-7}$ & $1.32$ & $6.45\times 10^{-5}$ & $1.45$ & $2.72\times 10^{-2}$ & $0.823$ \\
$\nicefrac{1}{80}$ & $13338$ & $2.54\times 10^{-7}$ & $1.52$ & $2.31\times 10^{-5}$ & $1.48$ & $1.56\times 10^{-2}$ & $0.803$ \\
$\nicefrac{1}{160}$ & $51740$ & $7.22\times 10^{-8}$ & $1.81$ & $6.76\times 10^{-6}$ & $1.77$ & $7.72\times 10^{-3}$ & $1.01$ \\
\hline
\end{tabular}
\caption{Observed rates of convergence for SQGE applied to the Mediterranean
  ...
  from fine mesh with $h=\dfrac{1}{320}$.}
  \label{tab:SQGEMedConvergence}
\end{table}

\begin{figure}
  \begin{center}
    \includegraphics[scale=0.7]{Figures/SQGEMedRe5_27Ro6_051E-4h320sin0_5piy.pdf}
    \caption{``True'' solution of SQGE on the Mediterranean with $Re = 5.27, Ro
      = 6.051\times 10^{-4}, F = \sin( \frac{\pi}{2} y)$, and 204,144 DoFs
      corresponding to $h = \frac{1}{320}$.}
    \label{fig:SQGEMed}
  \end{center}
\end{figure}
