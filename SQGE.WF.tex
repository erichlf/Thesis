We are now ready to derive the weak formulation of the SQGE in streamfunction formulation
...
%  The solution $\psi$ of \eqref{sqge_psi_1} satisifies the following stability estimate: 
%  \begin{equation}
